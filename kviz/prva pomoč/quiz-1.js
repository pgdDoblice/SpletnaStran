...
var cat14 = ($("input[@name=q14]:checked").val() != "c");  
...
var cat18 = ($("input[@name=q18]:checked").val() != "a");  

var cat19 = ($("input[@name=q19]:checked").val() != "a");  

var cat20 = ($("input[@name=q20]:checked").val() != "b");  

var cat21 = ($("input[@name=q21]:checked").val() != "c");  

var cat22 = ($("input[@name=g22]:checked").val() != "b");  

var cat23 = ($("input[@name=q23]:checked").val() != "b");  

var cat24 = ($("input[@name=q24]:checked").val() != "b");  

var cat25 = ($("input[@name=q25]:checked").val() != "a");  

var cat26 = ($("input[@name=q26]:checked").val() != "a");  

var cat27 = ($("input[@name=q27]:checked").val() != "b");  

var cat28 = ($("input[@name=q28]:checked").val() != "c");  

var cat29 = ($("input[@name=q29]:checked").val() != "c");  

var cat30 = ($("input[@name=q30]:checked").val() != "a");  

var cat31 = ($("input[@name=q31]:checked").val() != "b");  

var cat32 = (!cat1 && !cat2 && !cat3 && !cat4 && !cat5 && !cat6 && !cat7 && !cat8 && !cat9 && !cat10 && !cat11 && !cat12 && !cat13 && !cat14 && !cat15 && !cat16 && !cat17 && !cat18 && !cat19 && !cat20 && !cat21 && !cat22 && !cat23 && !cat24 && !cat25 && !cat26 && !cat27 && !cat28 && !cat29 && !cat30 && !cat31); var categories = [];                        
